...
OUT = output
TRANS = transforms
APP_XML=$(IN)/redaction.xml
TABLE=$(OUT)/redaction-table.html
SIMPLIFIED=$(OUT)/redaction-table-reqs.html
APP_HTML=$(OUT)/redaction.html
APP_OP_HTML=$(OUT)/redaction-optionsappendix.html
APP_RELEASE_HTML=$(OUT)/redaction-release.html
